...
<!-- 	
	 ...
	 -->
		...
		<form class="updateForm">
			...
			<div class="wirteButtonWarp">
				<button onclick="bupdate()" class="writeBtn btn btn-dark" type="button"> 수정 </button>
			</div>
		</form>
	...
	<script src="/JSPWEB/apply/js/board/update.js" type="text/javascript"> </script>
